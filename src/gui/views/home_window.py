...
class HomeWindow(QMainWindow):
    ...
    def create_ui(self):
        ...
        self.daily_tracking_groupbox = QtWidgets.QGroupBox('Daily tracking', self.main_frame)
        ...
        self.daily_tracking_save_btn = QtWidgets.QPushButton('Save', self.daily_tracking_groupbox)
        self.daily_tracking_button_box.addWidget(self.daily_tracking_save_btn, 0, Qt.AlignmentFlag.AlignRight)
        self.daily_tracking_box.setLayout(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.daily_tracking_button_box)

        self.budget_tracking_groupbox = QtWidgets.QGroupBox('Budget tracking', self.main_frame)
        ...
        self.income_tracking_groupbox = QtWidgets.QGroupBox('Income tracking', self.budget_tracking_groupbox)
        ...
        self.income_tracking_save_btn = QtWidgets.QPushButton('Save', self.income_tracking_groupbox)
        self.income_tracking_button_box.addWidget(self.income_tracking_save_btn, 0, Qt.AlignmentFlag.AlignRight)
        self.income_tracking_box.setLayout(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.income_tracking_button_box)

        self.spent_tracking_box = QtWidgets.QFormLayout()
        self.spent_tracking_groupbox = QtWidgets.QGroupBox('Spent tracking', self.budget_tracking_groupbox)
        ...
        self.spent_tracking_save_btn = QtWidgets.QPushButton('Save', self.spent_tracking_groupbox)
        self.spent_tracking_button_box.addWidget(self.spent_tracking_save_btn, 0, Qt.AlignmentFlag.AlignRight)
        self.spent_tracking_box.setLayout(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.spent_tracking_button_box)

        self.spent_tracking_save_btn.clicked.connect(self.spent_controller.save)
